    ...
    <div class="container">
        ...
        <div class="primaty-sections d-none d-md-block">
            ...
            <li class="nav-item primary-item">
                ...
                @auth
                <li class="nav-item primary-item">
                    <a class="primary-link" href="{{url("/user/profile")}}">
                        @if(Auth::user()->logo=="")
                            <img class="brand-logo circle"  src="{{asset('assets/images/users/avatar.png')}}">
                            @else
                            <img class="brand-logo circle"  src="{{Auth::user()->logo()}}">
                            @endif
                        {{-- <span class="brand-text">{{Auth::user()->first_name}} {{Auth::user()->last_name}}</span> --}}
                    </a>
                </li>
                @endauth
                </ul>
