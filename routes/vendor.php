...
Route::get('/profile', [ProfileController::class, 'index'])->name('vendor.profile');
Route::post('/profile_update/{id}', [ProfileController::class, 'update'])->name('vendor.profile_update');
